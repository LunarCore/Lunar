 ...
 *
 *   // network
 *   CLunarNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CLunarNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: LunarNetwork
// //   -- signature requirements : Key1(User)
// class CLunarNetworkVariable : public CGovernanceObject
// {
// private:
