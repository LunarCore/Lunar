...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "LunarNetwork") type = LunarNetwork;
    if(strType == "LunarNetworkVariable") type = LunarNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == LunarNetwork) s = "LunarNetwork";
    if(type == LunarNetworkVariable) s = "LunarNetworkVariable";
