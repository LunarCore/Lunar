    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Lunar Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Lunar Core"));
...
All the Lunar in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 LUNAR, 0.1 LUNAR, 1 LUNAR and 10 LUNAR -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://lunarpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://lunarpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Lunar Core is shutting down...") + "<br /><br />" +
