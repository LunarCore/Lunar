    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Lunar Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Lunar address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lunar: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Lunar Core"), this);
    aboutAction->setStatusTip(tr("Show information about Lunar Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Lunar Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Lunar addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Lunar addresses"));
    ...
    openAction->setStatusTip(tr("Open a lunar: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Lunar Core help message to get a list with possible Lunar Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Lunar Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Lunar Core"); // default title
