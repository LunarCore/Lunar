    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("LUNAR-light"), QVariant("light"));
    ui->theme->addItem(QString("LUNAR-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("LUNAR-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("LUNAR-traditional"), QVariant("trad"));
