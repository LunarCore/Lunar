...
{
    if(fLiteMode) return; // ignore all Lunar related functionality
...
/*
    ...
    allow endless transaction that would bloat Lunar and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("lunar-privatesend");
