...
This mechanism has been integrated into Bitcore-Node-Lunar which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/lunarpay/insight-api-lunar#web-socket-api](https://github.com/lunarpay/insight-api-lunar#web-socket-api) 
* API: [https://github.com/lunarpay/insight-api-lunar#instantsend-transactions](https://github.com/lunarpay/insight-api-lunar#instantsend-transactions) 
...
By default, the Lunar Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Lunar Core daemon:
