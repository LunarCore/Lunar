...
Only requiring some minor changes is lunar.cpp.
...
Changes to lunar.cpp
----------------------
lunar.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
